...
DEFINE_int64(schedulerNumber, 1, "the number of scheduler machines, by default 1 ");
...
systemParameter::systemParameter(std::string &machineFileName,
        ...
        :memberMachineFileName(machineFileName),
         ...
         memberSchedulerNumber(schedulerNumber) {
}
...
void systemParameter::init(int argc,char* argv[],int mpiRank, int mpiSize, int workerMachineNumber, int schedulerMachineNumber){
    ...
    this->createConfigFile(mpiRank,mpiSize,workerMachineNumber,schedulerMachineNumber);

}

void systemParameter::createConfigFile(int mpiRank, int mpiSize, int workerMachineNumber, int schedulerMachineNumber) {
    //TODO: 创建配置文件
    mkdir("./conf", 0777);
...
//        tmp->functionName.append("default-func");
    ...
    int workers = workerMachineNumber;
    int schedulers = schedulerMachineNumber;
    ...
    int clients = workerMachineNumber;
    int servers = schedulerMachineNumber;
